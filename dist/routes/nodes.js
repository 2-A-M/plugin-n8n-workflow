import { searchNodes, getNodeDefinition, getAllNodes, filterNodesByIntegrationSupport, } from '../utils/catalog';
 ...
 */
async function listNodes(req, res, _runtime) {
    try {
        const q = req.query?.q;
 ...
 */
async function listAvailableNodes(_req, res, runtime) {
    try {
        const catalog = getAllNodes();
        const allResults = catalog
 ...
 */
async function getNode(req, res, _runtime) {
    try {
